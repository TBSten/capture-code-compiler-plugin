...
## feature 配下 (task-123 で追加予定)

- `feature/<feature>/.../<Logic>Warnings.kt` — その logic から発火する Warning 集約 (例: `feature/capturedSources/.../<...>/NoMarkerFoundWarnings.kt`)
...
```kotlin
// compiler-plugin/compat/.../warning/SomeBilingualWarning.kt ← NG (task-122 撤去済)
