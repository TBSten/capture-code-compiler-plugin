 ...
 * 引数順を持つ abstract method として現れる。 root KGP 2.0.0 で compile する compat-k240
...
public final class K240CaptureCodeMarkerClassCheckerShim extends FirDeclarationChecker<FirRegularClass> {
    public static final K240CaptureCodeMarkerClassCheckerShim INSTANCE =
        new K240CaptureCodeMarkerClassCheckerShim();

    private K240CaptureCodeMarkerClassCheckerShim() {
    ...
    public void check(
        ...
        K240CaptureCodeMarkerClassCheckerLogic.INSTANCE.run(context, reporter, declaration);
    }
}
