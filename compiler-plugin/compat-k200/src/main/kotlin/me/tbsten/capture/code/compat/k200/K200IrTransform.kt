 ...
 */
internal fun runK200IrTransform(
    ...
    for (file in moduleFragment.files) {
        val collector = K200CapturedSourcesCollector(file, config)
 ...
 */
internal class K200CapturedSourcesTransformer(
    ...
    override fun visitCall(expression: IrCall): IrExpression {
        ...
        val rewritten = K200CapturedSourcesRewriter.rewriteCapturedSourcesCall(
    ...
    private fun IrCall.isCapturedSourcesCall(): Boolean =
        symbol.owner.fqNameWhenAvailable?.asString() == K200CapturedSourcesRewriter.CAPTURED_SOURCES_FQN
