 ...
 * 引数順を持つ abstract method として現れる。 root KGP 2.0.0 で compile する compat-k240rc
...
public final class K240RcCaptureCodeMarkerClassCheckerShim extends FirDeclarationChecker<FirRegularClass> {
    public static final K240RcCaptureCodeMarkerClassCheckerShim INSTANCE =
        new K240RcCaptureCodeMarkerClassCheckerShim();

    private K240RcCaptureCodeMarkerClassCheckerShim() {
    ...
    public void check(
        ...
        K240RcCaptureCodeMarkerClassCheckerLogic.INSTANCE.run(context, reporter, declaration);
    }
}
