...
import me.tbsten.capture.code.compat.k210.filler.CaptureKindFillerBuilder
import me.tbsten.capture.code.compat.k210.filler.FillerBuilder
import me.tbsten.capture.code.compat.k210.filler.SourceFillerBuilder
import me.tbsten.capture.code.compat.k210.filler.SourceLocationFillerBuilder
import me.tbsten.capture.code.compat.k210.userargs.UserArgIrBuilder
import me.tbsten.capture.code.compat.k210.userargs.UserArgPrimitiveIrBuilder
...
internal object K210CapturedSourcesRewriter {
    ...
    fun rewriteCapturedSourcesCall(
        original: IrCall,
        markerFqn: String,
        siteData: List<K210CapturedSiteData>,
