...
import me.tbsten.capture.code.compat.k230.filler.CaptureKindFillerBuilder
import me.tbsten.capture.code.compat.k230.filler.FillerBuilder
import me.tbsten.capture.code.compat.k230.filler.SourceFillerBuilder
 ...
 */
internal object K230CapturedSourcesRewriter {
    ...
    fun rewriteCapturedSourcesCall(
        original: IrCall,
        markerFqn: String,
        siteData: List<K230CapturedSiteData>,
