// Kotlin 2.2.x: putValueArgument / valueParameters の deprecation を file 単位で抑止 (旧 API でも runtime 動作する)。
@file:Suppress("DEPRECATION", "DEPRECATION_ERROR")
@file:OptIn(org.jetbrains.kotlin.DeprecatedForRemovalCompilerApi::class)

package me.tbsten.capture.code.compat.k230.userargs
 ...
 * IR 化するための helper。
 *
 * filler 自動値埋め ([me.tbsten.capture.code.compat.k230.filler.FillerBuilder]) との境界:
