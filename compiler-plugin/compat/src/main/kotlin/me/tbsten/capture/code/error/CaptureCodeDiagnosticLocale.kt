 ...
 * 各 compat-kXXX layer 内の diagnostic factory が参照するため公開モジュールに集約する。
 */
public enum class CaptureCodeMessageLocale {
    /** 英語と日本語を併記する (default)。 */
    BILINGUAL,
    ...
    public companion object {
         ...
         */
        public fun fromEnv(env: (String) -> String? = System::getenv): CaptureCodeMessageLocale =
 ...
 * `'item'` のままで通る。
 */
public data class BilingualMessage(
    public val en: String,
    public val ja: String,
) {
    /**
     ...
     */
    public fun render(locale: CaptureCodeMessageLocale): String = when (locale) {
